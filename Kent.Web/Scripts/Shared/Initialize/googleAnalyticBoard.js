...
gapi.analytics.ready(function () {
    ...
    function renderYearOverYearChart(ids, startDate, endDate) {
        ...
        var resMetrics = query({
            ids: ids,
            metrics: 'ga:sessions,ga:users,ga:visits,ga:pageviews,ga:percentNewVisits,ga:entranceBounceRate,ga:exitRate,ga:pageviewsPerVisit,ga:avgPageLoadTime',
            'start-date': startDate,
            'end-date': endDate
        });
        ...
        Promise.all([resusers, resMetrics, resSessions, resPageViews, resPagePerSession, resBounceRate, resPercNewVisits]).then(function (results) {
