...
(function (context) {
    ...
    context.viewDocument = function (url, mime, width, height) {
        ...
        var downloadUrl = url + "?isDownload=true";

        var embedContent = '<object data="' + url + '" type="' + mime + '" height="99%" width="100%" ><a class="center" onclick="$.fancybox.close()" href="' + downloadUrl + '" target="_blank" >Click here to download the document.</a></object>';
        $.fancybox({
            type: 'html',
            width: width,
            height: height,
